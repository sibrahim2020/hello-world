...
if(isset($_POST["submit"]))
{
	...
	WHERE loginid='$_POST[Loginid]' AND password='$_POST[password]' AND usertype='Admin'");
	...
	?>
    <div id="fpms_content" style="margin-top:-250px">
   	
        <div id="fpms_content_left">
        	<div class="header_02">Admin Login Page</div>
            <div class="image_frame_02"><a href="#"><img src="images/adminimg.png" alt="image" /></a></div>
            <p class="bi_para">&nbsp;</p>
...
{
	?>
              <form id="form2" name="form2" method="post" action="" onsubmit="return validateFormad()" style="margin-top:-60px">
                <p>&nbsp;<?php echo $msg; ?></p>
                <p>
